...
TERTIARY_DATA_ADDRESS = 0x06020DFC
TERTIARY_DATA_CAPACITY = 516

DECODED_FRAMEBUFFER = 0x0607704C
MOVIE_FRAMEBUFFER_STRIDE = 320
MOVIE_BYTES_PER_PIXEL = 4
BLOCKING_DMA_DESTINATION_POINTER = 0x060768B0
STREAM_DMA_DESTINATION_POINTER = 0x060BE248
BLOCKING_DISPLAY_ROW_STRIDE = 512 * MOVIE_BYTES_PER_PIXEL
STREAM_DISPLAY_ROW_STRIDE = MOVIE_FRAMEBUFFER_STRIDE * 2
...
def _build_runtime() -> _Runtime:
    ...
    symbols = {
        ...
        "BLOCKING_DMA_DESTINATION_POINTER": BLOCKING_DMA_DESTINATION_POINTER,
        "STREAM_DMA_DESTINATION_POINTER": STREAM_DMA_DESTINATION_POINTER,
        "BLOCKING_DISPLAY_ROW_STRIDE": BLOCKING_DISPLAY_ROW_STRIDE,
        "STREAM_DISPLAY_ROW_STRIDE": STREAM_DISPLAY_ROW_STRIDE,
