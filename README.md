...
combat dialogue, and START2 subtitle slices, but it does not yet cover the
rest of the game.
...
| PSP | Complete configured English title-help, CONFIG, command-help, battle-console, five-bank EVENT, BOSSTALK, and START2 subtitle build | Structurally verified; broader translation remains |
...
| `psp` | Font-resource catalogue plus authored title-help/CONFIG/command-help/battle-console/EVENT/BOSSTALK/START2 text, FONT16 and EVE rasters, the stock-safe EVENT VWF runtime, Allegrex patches, and checked same-size ISO publication; remaining surfaces and visuals remain to be ported |
